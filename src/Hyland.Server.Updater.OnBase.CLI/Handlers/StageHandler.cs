...
{
    internal sealed class StageHandler
    {
        ...
        public StageHandler(IRepository<Application> applicationRepo, IPackageRepository packageRepo, IUpdateService updateService, IApplicationFileInformationService fileInfoService)
        {
        ...
        public void HandleRequest(ParseResult parseResult)
        {
            ...
            {
                Console.WriteLine("Unexpected error staging update.");
                Console.WriteLine(e);
            }
        }
    }
