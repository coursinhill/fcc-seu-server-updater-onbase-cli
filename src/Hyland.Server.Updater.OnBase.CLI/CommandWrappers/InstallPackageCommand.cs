...
internal class InstallPackageCommand : CommandWrapperBase, ISubCommandWrapper
{
    public CommandType BaseCommand => CommandType.Package;

    protected override string Name => "install";

    protected override string Description => "Install the specified package";
    ...
    public InstallPackageCommand(IPackageRepository packageRepository, IRepository<Application> applicationRepository)
    {
    ...
    protected override void ExecuteInternal(ParseResult parseResult)
    {
        ...
        _packageRepository.InstallPackage(package, CancellationToken.None);
